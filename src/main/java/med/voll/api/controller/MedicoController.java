...
public class MedicoController {
    ...
    @PostMapping
    public ResponseEntity<DatosRespuestaMedico> registrarMedico(@RequestBody @Valid DatosRegistroMedico datosRegistroMedico, UriComponentsBuilder uriComponentsBuilder) { // sin anotacion no leera cuerpo de la solicitud ni va a mapear sus campos al DTO recibido como parámetro. @Valid para validar.
